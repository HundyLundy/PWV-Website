...
const config = {
  ...
  faqItems: [
    ...
    { q: "How does Smart Valve™ installation work in Boulder?", a: "A licensed plumber installs Smart Valve™ on the main supply line upstream of your meter in under 4 hours. Savings appear on your next bill. Perfect Water Valve guarantees at least 15% reduction in writing." },
  ],
