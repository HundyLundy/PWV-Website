...
const config = {
  ...
  subheadline: "Kentucky commercial water rates are now $8.0066 per 1,000 gallons, effective December 16, 2025. Water shortage regulations are imposing restrictions on non-residential water usage across the state. Smart Valve™ cuts your metered bill 15–58%, guaranteed — and keeps you below restriction thresholds.",
  ...
  faqItems: [
    { q: "Does Smart Valve™ help with Kentucky conservation mandate compliance?", a: "Yes. Kentucky's non-residential conservation mandates restrict commercial water usage. Smart Valve™ reduces your metered consumption 15–58%, helping you stay well below any consumption thresholds and avoid penalties or permit restrictions." },
  ...
  seoDescription: "Smart Valve™ cuts commercial water bills 15–58% in Kentucky. Rate $8.0066/1,000 gal effective Dec 2025. Non-residential conservation mandates active. Guaranteed savings in writing.",
