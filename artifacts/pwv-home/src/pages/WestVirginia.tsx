...
const config = {
  ...
  subheadline: "West Virginia American Water is raising commercial rates by $3.97/month in 2025, with a further $1.94/month increase in 2026. West Virginia's aging water infrastructure requires ongoing capital investment, and commercial customers fund this through annual rate increases. Smart Valve™ cuts your bill 15–58%, guaranteed.",
  ...
  faqItems: [
    ...
    { q: "How much will WV American Water's rate schedule cost over two years?", a: "A property paying $10,000/month will pay an additional $3.97 × 12 = $47.64 more per month in 2025, then another $1.94 × 12 = $23.28 more monthly in 2026 — compounding annually. Smart Valve™'s 15–58% consumption reduction saves far more than these increases on an ongoing basis." },
  ...
  seoDescription: "Smart Valve™ cuts commercial water bills 15–58% in West Virginia. WV American Water raising rates $3.97/month in 2025 and $1.94/month in 2026. Guaranteed savings in writing. Free assessment.",
