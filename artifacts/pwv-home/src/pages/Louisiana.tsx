...
const config = {
  ...
  subheadline: "Magnolia Water raised commercial rates 8% in 2024 and 7% in 2025. St. James Parish implemented commercial flat rate increases in 2025. Louisiana's aging water infrastructure is requiring massive investment, and commercial customers fund it through annual rate increases. Smart Valve™ cuts your bill 15%–35% annually, guaranteed.",
  ...
  whyPoints: [
    { icon: "TrendingUp", color: "red", title: "Magnolia Water: 8% in 2024, 7% in 2025 — Compounding", body: "Magnolia Water implemented 8% commercial rate increases in 2024 and 7% in 2025. At this pace, a property paying $20,000/month in 2023 is now paying over $23,000/month — and the trend is expected to continue. Smart Valve™ cuts consumption 15%–35% annually, directly offsetting these compounding increases." },
  ...
  seoDescription: "Smart Valve™ cuts commercial water bills 15%–35% annually in Louisiana. Magnolia Water up 8% in 2024, 7% in 2025. Aging infrastructure driving annual increases. Guaranteed savings in writing.",
