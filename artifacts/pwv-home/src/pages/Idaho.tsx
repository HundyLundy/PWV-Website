...
const config = {
  ...
  subheadline: "Boise's population grew 16% in 5 years. Boise City raised commercial water rates 7% in 2025. Snake River Plain aquifer levels are declining. Idaho Falls increased 6.5%. Smart Valve™ helps Idaho commercial properties cut costs 15%–35% annually.",
