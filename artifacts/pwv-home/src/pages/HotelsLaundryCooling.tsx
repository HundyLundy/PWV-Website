...
export default function HotelsLaundryCooling() {
  useEffect(() => {
    ...
    document.title = "Hotel Laundry & Cooling Tower Water Costs | Smart Valve™ | Perfect Water Valve";
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            {[
              ...
              { icon: CheckCircle, title: "Smart Valve™ Reduces Total Metered Water Consumption", body: "Smart Valve™ eliminates Phantom Volume — dissolved air that expands through the pressure regulator and inflates meter readings. By maintaining upstream compression, only real water registers on the meter. Reduced metered consumption applies to all downstream uses, including laundry, automatically." },
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            {[
              ...
              { icon: TrendingDown, title: "Smart Valve™ Reduces All Metered Water Consumption", body: "Smart Valve™ maintains upstream pressure to prevent Phantom Volume — the dissolved air that expands through the pressure regulator and inflates meter readings across every downstream use, including cooling tower makeup. Less Phantom Volume means less billed water volume." },
              { icon: CheckCircle, title: "The Same Mechanism as Amazon YYZ3", body: "This is the same Phantom Volume elimination mechanism that produced the Amazon YYZ3 58.69% peak result in data centers. The physics are identical — upstream pressure maintenance prevents air from spinning the meter without delivering real water, regardless of end use (cooling towers, laundry, guest rooms, kitchen)." },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              { step: "2", title: "Phantom Volume Elimination — No Chemicals, No Electricity", body: "Smart Valve™ uses a patent-protected spring-loaded mechanical mechanism to maintain upstream pressure and prevent air expansion through the meter. No chemicals added, no electricity required, no maintenance after installation. NSF/ANSI/CAN 61 and NSF/ANSI 372 certified safe for all hotel water applications." },
