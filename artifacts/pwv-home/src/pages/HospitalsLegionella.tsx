        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            {[
              ...
              { icon: ShieldCheck, title: "Reducing Air Entrainment Reduces Dead Zone Formation", body: "Smart Valve™ uses a patent-protected mechanical hydrodynamic mechanism to maintain upstream pressure, preventing dissolved air from expanding and forming free air pockets in the distribution system. By reducing air entrainment, it eliminates a primary condition for stagnant dead zone formation in hospital water distribution systems." },
            ].map((item, i) => (
