        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              { step: '03', title: 'IPMVP-Compliant M&V Reports', body: 'AWS conducts independent measurement and verification every 6–12 months, issued as formal PDF reports. ASHRAE 188 and Joint Commission compatible documentation available.' },
            ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: AlertTriangle, color: "red", title: "Zero Clinical Operational Impact", body: "Smart Valve™ is fully passive — no electricity required, no control systems. Installation takes 2–4 hours on the main supply line and does not affect water pressure, flow, or quality to any clinical area." },
