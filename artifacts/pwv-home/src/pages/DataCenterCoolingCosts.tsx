        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            {[
              ...
              { icon: Server, title: "Phantom Volume — The Hidden Driver of Inflated Cooling Water Bills", body: "City water enters at ≈250 psi in distribution mains, keeping dissolved air fully compressed. When pressure drops to 50–110 psi at your building's PRV, air expands 4–5× and inflates meter readings. Smart Valve™ maintains upstream compression, so your meter registers only real water — not air — directly reducing your billed cooling water volume." },
            ].map((item, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { step: "1", title: "Installed on the User Side of the Meter", body: "Smart Valve™ is installed on the main supply line on the user side of the water meter — between the meter and the pressure regulator. By creating back pressure upstream, it prevents the pressure drop that causes dissolved air to expand through the meter, so only real water is recorded and billed." },
              { step: "2", title: "Phantom Volume Elimination — No Chemicals, No Electricity", body: "Smart Valve™ uses a patent-protected spring-loaded mechanical mechanism to maintain upstream pressure. This prevents the decompression zone that allows dissolved air to expand 4–5× through the meter. The utility's own meter records the reduction — no proprietary sensors involved." },
