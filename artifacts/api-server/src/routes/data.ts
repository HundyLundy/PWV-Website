...
router.get("/customers", (_req, res): void => {
  const data = GetCustomersResponse.parse([
    ...
    {
      id: "st-regis-toronto",
      clientName: "The St. Regis Toronto",
      ...
      peakSavingsPct: 20,
      monthlyUsageM3: 5200,
      annualWaterSavedM3: 12472,
      annualCostSaved: 49889,
      status: "verified",
      highlight: "$49,889 year-over-year savings — 20%+ water cost reduction at a flagship Marriott property",
      logoLetter: "S",
      testimonial: "Now, more than a year later, the results speak for themselves: year-over-year savings of $49,889, representing 20%+ in water-cost reduction.",
      testimonialAuthor: "Priyan Jayetileke, Chief Engineer, The St. Regis Toronto",
      currencyNote: "CAD",
    },
    {
      id: "hotel-chain",
