          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <div className="space-y-4 mb-12">
                ...
                <div className="flex items-center gap-3 text-lg text-gray-300">
                  <CheckCircle2 className="text-primary w-6 h-6 shrink-0" />
                  <span><strong>Texas Specialists</strong> — Serving Houston, Dallas, Austin, San Antonio &amp; beyond</span>
                </div>
                <div className="flex items-center gap-3 text-lg text-gray-300">
                  <CheckCircle2 className="text-primary w-6 h-6 shrink-0" />
              ...
              <div className="bg-[#121B2E] p-8 rounded-2xl border border-white/10">
                <h4 className="text-sm uppercase tracking-wider text-gray-400 font-bold mb-4">Your Texas Contact</h4>
                <div className="text-2xl font-bold text-white mb-2">{REP_INFO.name}</div>
                <a href={`tel:${REP_INFO.phone.replace(/[^0-9]/g, '')}`} className="block text-primary text-xl font-medium hover:underline mb-2">{REP_INFO.phone}</a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li>El Paso & Corpus Christi</li>
                <li className="text-primary font-medium">All of Texas</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li><a href={`tel:${REP_INFO.phone.replace(/[^0-9]/g, '')}`} className="hover:text-primary transition-colors">{REP_INFO.phone}</a></li>
    ...
    try {
      await fetch(GHL_WEBHOOK_URL, {
        ...
        body: JSON.stringify({
          ...
          source: "perfectwatervalve.com/texas - Assessment Form",
        }),
      });
    } catch (err) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          ...
          <input value={form.phone} onChange={e => setForm({ ...form, phone: e.target.value })}
            className={inputCls} placeholder="(713) 555-0100" type="tel" />
        </div>
        <div>
      ...
      <p className="text-xs text-center text-gray-400 pt-1">
        No obligation. We'll personally follow up within one business day.
      </p>
    </form>
  );
}
