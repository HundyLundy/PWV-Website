...
const INDUSTRIES = [
  { name: "Data Centers", path: "/locations/industries/data-centers", emoji: "🖥️" },
  { name: "Hotels & Hospitality", path: "/locations/industries/hotels", emoji: "🏨" },
  { name: "Car Washes", path: "/locations/industries/car-washes", emoji: "🚗" },
  { name: "Multifamily Residential", path: "/locations/industries/multifamily", emoji: "🏢" },
  { name: "Hospitals & Healthcare", path: "/locations/industries/hospitals", emoji: "🏥" },
];
